...
func generateMysqlTypes(obj map[string]map[string]string, columnsSorted []string, depth int, jsonAnnotation bool, gormAnnotation bool, commentAnnotation bool, gureguTypes bool) string {
	structure := "struct {"
